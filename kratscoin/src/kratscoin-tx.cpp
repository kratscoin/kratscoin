...
static void SetupKratscoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kratscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kratscoin-tx [options] <hex-tx> [commands]  Update hex-encoded kratscoin transaction\n" +
            "or:     kratscoin-tx [options] -create [commands]   Create hex-encoded kratscoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded kratscoin transaction
