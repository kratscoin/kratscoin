...
#ifndef KRATSCOIN_QT_KRATSCOINUNITS_H
#define KRATSCOIN_QT_KRATSCOINUNITS_H
...
/** Kratscoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KratscoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KratscoinUnits(QObject *parent);

    /** Kratscoin units.
      @note Source: https://en.kratscoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KTC,
...
typedef KratscoinUnits::Unit KratscoinUnit;

#endif // KRATSCOIN_QT_KRATSCOINUNITS_H
