    ...
    mapper(0)
{
    ...
    ui->kratscoinAtStartup->setToolTip(ui->kratscoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->kratscoinAtStartup->setText(ui->kratscoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openKratscoinConfButton->setToolTip(ui->openKratscoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new KratscoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->kratscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openKratscoinConfButton_clicked()
{
