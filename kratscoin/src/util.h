 ...
 */
#ifndef KRATSCOIN_UTIL_H
#define KRATSCOIN_UTIL_H
...
extern const char * const KRATSCOIN_CONF_FILENAME;
extern const char * const KRATSCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("kratscoin-%s", name);
