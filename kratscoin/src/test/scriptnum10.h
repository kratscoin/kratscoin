...
#ifndef KRATSCOIN_TEST_SCRIPTNUM10_H
#define KRATSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kratscoin Core 0.10.0, for cross-comparison.
 */
public:
