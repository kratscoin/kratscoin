...
#ifndef KRATSCOIN_INTERFACES_NODE_H
#define KRATSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a kratscoin node (kratscoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // KRATSCOIN_INTERFACES_NODE_H
