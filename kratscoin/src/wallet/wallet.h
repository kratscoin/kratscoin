...
#ifndef KRATSCOIN_WALLET_WALLET_H
#define KRATSCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this kratscoin node, and set to 0 for transactions that were created
...
#endif // KRATSCOIN_WALLET_WALLET_H
