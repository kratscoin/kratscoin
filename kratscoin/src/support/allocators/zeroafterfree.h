...
#ifndef KRATSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define KRATSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // KRATSCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
