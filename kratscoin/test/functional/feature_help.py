...
"""Verify that starting kratscoin with -h works as expected."""

from test_framework.test_framework import KratscoinTestFramework
from test_framework.util import assert_equal

class HelpTest(KratscoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kratscoin with -h for help text")
        ...
        self.log.info("Start kratscoin with -version for version information")
        ...
        self.log.info("Start kratscoind with -fakearg to make sure it does not start")
