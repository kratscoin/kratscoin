...
# TestP2PConn: A peer we use to send messages to kratscoind, and store responses.
...
class CompactBlocksTest(KratscoinTestFramework):
    ...
    # This test actually causes kratscoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kratscoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kratscoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kratscoind will not send blocktxn responses for blocks whose height is
