...
* kratscoin.conf: contains configuration settings for kratscoind or kratscoin-qt
* kratscoind.pid: stores the process id of kratscoind while running
...
* debug.log: contains debug information and general logging generated by kratscoind or kratscoin-qt
