...
This document provides guidelines for internationalization of the Kratscoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kratscoin_en.ts` remains unchanged.
