...
- #7209 `f3ad812` test: don't override KRATSCOIND and KRATSCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add KRATSCOIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
...
- #6504 `b6fee6b` Rationalize currency unit to "KTC" (Ross Nicoll)
